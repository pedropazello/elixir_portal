defmodule Portal do
  ...
  def transfer(left, right, data) do
    ...
    # Returns a portal structure we will use next
  ...
  def push_right(portal) do
    ...
    # pooped data to the right. Otherwise, do nothing.
  ...
  @doc """
  Pushes data to the left in the givel `portal`.
  """
  def push_left(portal) do
    # Same thing from push_right, but it push the pooped
    # data to the left
